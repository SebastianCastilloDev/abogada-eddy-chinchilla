...
const WhatsAppFloatingButton = () => (
  <div className="fixed bottom-6 right-6 z-50 group">
    <a
      href={`https://wa.me/${LAWYER.whatsapp.replace(/[-\s]/g, '')}?text=Hola%20Abogada%20Eddy,%20me%20gustaría%20agendar%20una%20consulta`}
      className="flex items-center justify-center w-14 h-14 rounded-full bg-green-500 text-white shadow-lg hover:bg-green-600 transition-colors duration-300 relative"
